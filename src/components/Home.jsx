...
function Home() {
  ...
  return (
    <div className="w-full h-screen relative">
      <Navbar /> {/* Navbar include kiya */}
      <img className="h-full w-full object-cover" src={image} alt="" />
      <div className="absolute top-50 left-0 w-[45%] h-[50%] flex flex-col text-white justify-center bg-blue-200/10 rounded-4xl items-center px-10 mx-10">
        ...
        >
          {user ? (
            ...
            <>
              <Link to="/register">
                <button className="bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-300 transition">
                  Register Now
                </button>
              </Link>
